...
def items_for_result(view, result):
    ...
    for field_name in view.list_display:
        ...
        url_to_edit = view.url_helper.get_action_url('edit', quote(lookup_field('pk', result, modeladmin)[2]))
        if field_name in ['title', ]:
            yield format_html('<td class="title"><div class="title-wrapper"><a href="{}">{}</a></div></td>', url_to_edit, result_repr)
        else:
...
@register.inclusion_tag("modeladmin/blog/blogpage/includes/result_list.html",
                        takes_context=True)
...
@register.inclusion_tag(
    "modeladmin/blog/blogpage/includes/search_form.html", takes_context=True)
...
def admin_list_filter(view, spec):
    ...
    if template_name == 'admin/filter.html':
        template_name = 'modeladmin/blog/blogpage/includes/filter.html'
...
@register.inclusion_tag(
    "modeladmin/blog/blogpage/includes/result_row.html", takes_context=True)
...
@register.inclusion_tag(
    "modeladmin/blog/blogpage/includes/result_row_value.html", takes_context=True)
